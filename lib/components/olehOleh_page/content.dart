      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            height: 115,
            padding: const EdgeInsets.only(top: 11, left: 11, bottom: 11, right: 14),
            decoration: BoxDecoration(color: Color.fromRGBO(217, 217, 217, 1), borderRadius: BorderRadius.circular(5)),
            child: Row(
              children: [
                Image.asset('assets/images/ragusa.png', width: 92, height: 92,),
                SizedBox(width: 14,),
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Ragusa Es Italia', style: semiBold12,),
                      SizedBox(height: 7,),
                      Flexible(
                        child: Text('Jl. Veteran I No.10, RT.4/RW.2, Gambir, Kecamatan Gambir, Kota Jakarta Pusat, Daerah Khusus Jakarta 10110', style: medium8, softWrap: true,)
                      ),
                      SizedBox(height: 7,),
                      Text('Jajanan, Makanan Manis, Minuman', style: medium8.copyWith(color: Color.fromRGBO(0, 0, 0, 0.53)),),
                      SizedBox(height: 7,),
